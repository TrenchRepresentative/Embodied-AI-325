...
```bash
git clone https://github.com/TrenchRepresentative/Embodied-AI-325.git
cd Embodied-AI-325
python setup.py
```
...
- ✨  [Pull Request](https://github.com/TrenchRepresentative/Embodied-AI-325/pulls) 直接提交内容更新。
- 🐛  [Issue](https://github.com/TrenchRepresentative/Embodied-AI-325/issues) 反馈错误或提出建议。
...
@misc{octoday_robotics_2026,
  ...
  title  = {具身智能知识索引与产业地图},
  year   = {2026},
  url    = {https://github.com/TrenchRepresentative/Embodied-AI-325}
}
```
...
<!-- Last updated: 2026-06-06 14:50:12 -->
